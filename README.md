...
$$ 
\large M = 2^{(q \cdot 2)} \cdot 16
$$

### in which q is the number of qubits in the stage and M is the memory required, and at 20 qubits, the memory needed will exeed 16 terabytes. If the user plans to modify any of the stages in the application or create custom stages of their own, please keep this in mind.
...
## UML:
![UML](https://github.com/9674036-code/EthanTangCP2SoloProject/blob/main/images/AtomsimUML.png?raw=true)
